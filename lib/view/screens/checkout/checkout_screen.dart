...
// bool _orangePaymentActive = true;
...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  bool _orangePaymentActive;
  bool _afriPaymentActive;
  ...
  void initState() {
    ...
    if (_isLoggedIn) {
      ...
      _orangePaymentActive =
          Get.find<SplashController>().configModel.orangePayment;
      _afriPaymentActive = Get.find<SplashController>().configModel.afriPayment;
      _isWalletActive =
                                        ...
                                        Container(
                                          ...
                                          child: Column(children: [
                                            Column(
                                                ...
                                                children: [
                                                  Text(
                                                      'Orange Money 079619164 || Afri Money 030765843'
                                                          .tr,
                                                      style: robotoMedium),
                                                  SizedBox(
                                                      height: Dimensions
  ...
  void _callback(
    ...
    if (isSuccess) {
      ...
      if (Get.find<OrderController>().paymentMethodIndex == 0 ||
          ...
          Get.find<OrderController>().paymentMethodIndex == 4) {
        Get.offNamed(
